...
$(VAR):
	python3  pyxi_any_group_between_celltypes.py ${INPUT_FILE} ${OUTPUT_FILE} narrow_group $@ $(CELL_TYPE_NAMES) ${RANDOM_SEED} ${N_ITERATIONS} ${N_JOBS}
